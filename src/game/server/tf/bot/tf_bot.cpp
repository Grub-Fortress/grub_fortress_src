...
const char *GetRandomBotName( void )
{
	static const char *nameList[] =
	{
		...
		// Grub Fortress
		"xXx_Soldier2018Main_XxX",
		"Grubston-Hale",
		"HuntDownTheManInTheHEVSuit",
		"JohnFreeman",
		"MrGrubTheGrubGrubster",
		"GrubIsCool",
		"HLX Is Real!",
		// TF:Grub Community Suggested names (by Tyro/Xerin, the same one behind the amazing PF2 Servers :))
		"Grubbin' It",
		"Injected DLL",
		"Don't read this",
		"Funky!",
